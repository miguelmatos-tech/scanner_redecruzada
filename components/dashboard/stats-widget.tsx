...
import { ArrowDown, ArrowUp, BicepsFlexed, FileText } from "lucide-react"
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Link href="/transactions">
          <Card className="bg-gradient-to-br from-white via-orange-50/30 to-amber-50/40 border-orange-200/50 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Lucro Líquido</CardTitle>
              <BicepsFlexed className="h-4 w-4 text-orange-500" />
            </CardHeader>
            <CardContent>
